  ...
  return (
    <main className="min-h-screen">
      <section className="mx-auto max-w-4xl px-4 pb-4 pt-16 text-center sm:pt-20">
        <div className="fade-up mx-auto flex h-24 w-24 items-center justify-center rounded-[2rem] bg-white shadow-xl shadow-orange-100 ring-1 ring-gray-100 dark:bg-gray-900 dark:shadow-black/30 dark:ring-gray-800">
          <Logo size={64} />
        </div>
        ...
        <p className="fade-up-2 mx-auto mt-4 max-w-2xl text-sm leading-8 text-gray-500 dark:text-gray-400 sm:text-base">
        ...
        <div className="fade-up-3 mx-auto mt-9 grid max-w-3xl grid-cols-2 gap-3 sm:grid-cols-5">
          ...
          <div className="rounded-2xl border border-gray-100 bg-white p-4 shadow-sm dark:border-gray-800 dark:bg-gray-900">
            ...
            <p className="text-[11px] font-bold text-gray-400">ایده AI</p>
          </div>
          <div className="rounded-2xl border border-gray-100 bg-white p-4 shadow-sm dark:border-gray-800 dark:bg-gray-900">
      ...
      <section className="relative mx-auto mt-10 max-w-5xl px-4">
        <div className="absolute inset-0 -z-10 rounded-[2.5rem] bg-gradient-to-b from-orange-50 via-white to-white dark:from-orange-950/20 dark:via-gray-900 dark:to-gray-950" />
        <div className="relative rounded-[2.5rem] border border-orange-100/70 p-6 shadow-xl shadow-orange-100/40 backdrop-blur dark:border-orange-900/30 dark:shadow-black/30 sm:p-8">
          <div className="mb-6 flex items-center justify-between">
            ...
            <span className="rounded-full bg-[#ff6154] px-3 py-1 text-[10px] font-black text-white">LIVE</span>
          </div>
          {data ? (
            <Dashboard data={data} />
          ) : (
            <div className="rounded-3xl border-2 border-dashed border-gray-200 bg-white p-12 text-center text-gray-500 dark:border-gray-800 dark:bg-gray-900">
